...
PROVER_SEED_ENV = "VELARIS_PROVER_SEED"
...
def prover_seed() -> int | None:
    """Z3's random seed, from VELARIS_PROVER_SEED, or None for Z3's own.
    ...
    text = os.environ.get(PROVER_SEED_ENV, "").strip()
...
def check_proofs(funcs: list[Function], records: list[Any],
    ...
    if (_state._proof_timeout is None and os.environ.get(PROOF_TIMEOUT_ENV)
