#!/usr/bin/env python3
"""A Sabline whose budget checks have been knocked out - what a fault in the
...
language alone. It is not part of Sabline and is not shipped.
...
import sabline  # noqa: E402,F401
from sabline import cli  # noqa: E402
