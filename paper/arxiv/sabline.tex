...
wideable from within \citep{ailang} - Sabline's arrangement, at the
granularity of the category rather than the resource, and polymorphic in
its rows where Sabline's \texttt{uses} is a fixed set. No entry combines
