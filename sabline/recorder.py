...
#     files `sabline attest` names, by the same digests, so an audit and a
...
#     (sabline-spec 8.7), and it is signed the way an attestation is.
#
...
def _note_error(e: Any) -> None:
    """A SablineError stopped the run: what its receipt records of that."""
