...
# ---------------------------------------------------------------------------
# 4. EFFECT CHECKER — the heart of Sabline
...
def run_params() -> dict[Any, Any] | None:
    ...
    for the invocation log (sabline.invocation/1)."""
...
def warn_allow_all(where: str = "sabline") -> None:
...
# is the escaping rule of sabline-spec v0.2 (§5.1, §5.2). Only these five
...
def _add_opener(origin: str) -> Any:
    """The opener `sabline add` fetches through (8.0). It refuses a
